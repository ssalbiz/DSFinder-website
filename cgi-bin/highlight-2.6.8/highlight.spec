...
%package gui
Summary: The highlight GTK GUI.
Group: Development/Tools
%description gui
A wxWidgets based GUI version of the highlight utility.
...
install -d $RPM_BUILD_ROOT%{_datadir}/highlight/gui_files/ext $RPM_BUILD_ROOT%{_datadir}/highlight/gui_files/i18n
install -m644 ./gui_files/i18n/*  $RPM_BUILD_ROOT%{_datadir}/highlight/gui_files/i18n/
...
%postun gui
rmdir  %{_datadir}/highlight/gui_files/i18n %{_datadir}/highlight/gui_files/ext
...
%{_datadir}/highlight/gui_files/i18n/*
